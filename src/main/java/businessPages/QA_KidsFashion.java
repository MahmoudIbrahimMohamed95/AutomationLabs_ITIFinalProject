...
public class QA_KidsFashion implements IQA_ProductPage {
    ...
    private static final By electronicsDropSelection=By.xpath("//a[normalize-space()='Electronics']");
    //Attributes
    ...
    //constructor
    public QA_KidsFashion(WebDriver driver) {
        this.driver = driver;
    ...
    @Override
    public QA_KidsFashion addToCart(String productName) {
    ...
    public boolean isProductPageLoaded() {
        ...
        return actions.getText(breadcrumbLocator).contains("Kids Wear");
    }


    public QA_KidsFashion selectColorFilter(String color) {
        commonFilters.selectColorFilter(color);
        return this;
    }

    public QA_KidsFashion selectSizeFilter(String size) {
        commonFilters.selectSizeFilter(size);
        return this;
    }

    public QA_KidsFashion selectPriceFilter(String price) {
        commonFilters.selectPriceFilter(price);
        return this;
    }

    public QA_KidsFashion selectTypeFilter(String filterType) {
    ...
    public QA_Electronics selectShopCategory() {
        actions.hover(dropDownShop)
                .click(dropDownShop)
                .click(dropDownShop)
                .click(electronicsDropSelection);
