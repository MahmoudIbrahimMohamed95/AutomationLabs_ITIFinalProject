...
public class QA_MenFashion implements IQA_ProductPage {
    ...
    private static final By womenDropSelection=By.xpath("//a[normalize-space()='Womens Wear']");
    //Attributes
    ...
    //constructor
    public QA_MenFashion(WebDriver driver) {
        this.driver = driver;
    ...
    @Override
    public QA_MenFashion addToCart(String productName) {
    ...
    public boolean isProductPageLoaded() {
        ...
        return actions.getText(breadcrumbLocator).contains("Mens Wear");
    }


    public QA_MenFashion selectColorFilter(String color) {
        commonFilters.selectColorFilter(color);
        return this;
    }

    public QA_MenFashion selectSizeFilter(String size) {
        commonFilters.selectSizeFilter(size);
        return this;
    }

    public QA_MenFashion selectPriceFilter(String price) {
        commonFilters.selectPriceFilter(price);
        return this;
    }

    public QA_MenFashion selectTypeFilter(String filterType) {
    ...
    //Hint
    @Override
    public QA_WomenFashion selectShopCategory()  {
        actions.click(dropDownShop)
                .click(dropDownShop)
               .click(womenDropSelection);
